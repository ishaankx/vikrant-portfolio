          ...
          <ScrollReveal direction="left" distance={40}>
            <div style={{ position: "relative" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-start", justifyContent: "space-between", gap: "12px" }}>
                ...
                <span style={{ padding: "6px 16px", background: "#EDE8E0", borderRadius: "6px", fontSize: "11px", textTransform: "uppercase", letterSpacing: "0.1em", border: "1px solid rgba(140,112,81,0.1)", fontFamily: "'Plus Jakarta Sans', sans-serif", color: "#6B5E54", whiteSpace: "nowrap" }}>July 2024 — Present</span>
              </div>
