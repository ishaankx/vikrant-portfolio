    ...
    <footer style={{ background: "#EDE8E0", padding: "48px 24px", display: "flex", flexDirection: "column", alignItems: "center", gap: "20px", width: "100%", borderTop: "1px solid rgba(140,112,81,0.1)" }}>
      ...
      <div style={{ display: "flex", gap: "32px" }}>
        {["LinkedIn", "Twitter", "Instagram"].map((social) => (
          <a key={social} href="#" style={{ color: "#C4B8AC", fontSize: "10px", letterSpacing: "0.15em", textTransform: "uppercase", textDecoration: "none", transition: "color 0.3s", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 600 }}
